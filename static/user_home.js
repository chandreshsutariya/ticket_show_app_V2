      ...
      <nav class="navbar navbar-expand-lg bg-warning">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
              <div class="navbar-nav">
                  <a class="nav-link mr-auto" aria-current="page"> <router-link to="/user_home">{{current_user}}</router-link> </a>
                  <a class="nav-link" ><router-link to="/bookings"> Your Bookings </router-link></a>
